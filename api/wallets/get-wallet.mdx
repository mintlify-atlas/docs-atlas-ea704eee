---
title: "GET /wallet/<id> — Retrieve a Wallet by ID"
sidebarTitle: "GET /wallet"
description: "GET /wallet/<id> returns the wallet name and description for the given ID. Requires an active session."
---
