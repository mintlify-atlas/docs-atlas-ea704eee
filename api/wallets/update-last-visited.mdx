...
sidebarTitle: "Update Last Visited"
description: "Sets the current user's active wallet context by wallet ID. Transaction queries, charts, and summaries scope to this wallet until changed. Login required."
---
