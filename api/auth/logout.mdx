---
title: "GET /logout — Terminate the Current User Session"
sidebarTitle: "GET /logout"
description: "GET /logout calls Flask-Login's logout_user() to clear the session cookie and redirects the now-unauthenticated user back to the application home page."
---
