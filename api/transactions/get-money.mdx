---
title: "GET /money/<id> — Retrieve a Single Money Transfer"
sidebarTitle: "Get Transfer"
description: "Retrieve a single MoneyTransfer record by its ID. Returns the amount, description, and creation timestamp in ISO 8601 format. Requires authentication."
---
