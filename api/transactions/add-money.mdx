---
title: "POST /add_money — Create a new money transfer"
sidebarTitle: "POST /add_money"
description: "Create a new MoneyTransfer for the current user's active wallet. Accepts amount, description, optional timestamp, and a list of tag names that auto-create categories."
---
