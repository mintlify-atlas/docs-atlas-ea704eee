---
title: "GET /money_transfers_by_category/<category_id> — Transfers by category"
sidebarTitle: "GET /money_transfers_by_category/<id>"
description: "Return all MoneyTransfer records in the user's active wallet that are tagged with the given category ID. Results include full tag lists and creator username per transfer."
---
