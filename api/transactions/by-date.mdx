---
title: "POST /money_transfer_from_date — Transfers by Date"
sidebarTitle: "By Date"
description: "Return all MoneyTransfer records on a specific local calendar day in the active wallet. Timezone-aware: boundaries are converted to UTC for querying."
---
